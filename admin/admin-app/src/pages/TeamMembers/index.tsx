...
const TeamMembers = () => {
  const [activeTab, setActiveTab] = useState<'members' | 'profiles'>('members');
      ...
      <div className={styles.tabsContainer}>
        <div className={styles.tabsHeader}>
          ...
          >
            ...
            <span className={styles.tabBadge}>{teamMembers.length}</span>
          </button>
          ...
          >
            ...
            <span className={styles.tabBadge}>{profiles.length}</span>
          </button>
        </div>

        <div className={styles.tabsContent}>
          <div className={`${styles.tabPanel} ${activeTab === 'members' ? styles.tabPanelActive : ''}`}>
            <TeamMembersCard
          ...
          <div className={`${styles.tabPanel} ${activeTab === 'profiles' ? styles.tabPanelActive : ''}`}>
            <WorkProfilesCard
              profiles={profiles}
              loading={loading}
              isExpanded={true}
