...
import { TermsCard } from './TermsCard.js';
  ...
  return (
    <div className={pageStyles.pageContainer}>
      ...
      <div style={{ marginBottom: '24px' }}>
        <h1 className={pageStyles.pageTitle}>Terms & Policies</h1>
        <p className={pageStyles.pageDescription}>Define your terms of service, payment terms, and policies. These will be included in proposals and customer agreements.</p>
      </div>
      <TermsCard
