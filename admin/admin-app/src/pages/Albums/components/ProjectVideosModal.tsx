...
import styles from './ProjectVideosModal.module.css';

interface ProjectVideosModalProps {
  isOpen: boolean;
  onClose: () => void;
  project: any;
  onUpdate?: () => void;
...
export const ProjectVideosModal = ({ isOpen, onClose, project, onUpdate }: ProjectVideosModalProps) => {
  ...
  const handleAddVideo = async () => {
    ...
    try {
      ...
      showToast('error', 'Failed to add video');
    } finally {
      setIsAdding(false);
    }
  };
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Project Videos" size="large">
