      ...
      <div className={styles.drawer} data-closing={isClosing}>
        ...
        <nav className={styles.menuArea}>
          <div className={styles.menuSection}>
            ...
            <Link to={ROUTES.ORGANIZATION_BASIC_DETAILS} onClick={handleClose} className={`${styles.menuLink} ${location.pathname.startsWith(ROUTES.ORGANIZATION) ? styles.active : ''}`}>
              <svg className={styles.menuIcon} fill="none" stroke="currentColor" viewBox="0 0 24 24">
